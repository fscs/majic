...
var self__ = this;
var coll__$1 = this;
var x__9820__auto__ = self__.key;
return cljs.core._conj((function (){var x__9820__auto____$1 = self__.val;
...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9537__auto__,writer__9538__auto__,opt__9539__auto__){
return cljs.core._write(writer__9538__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_17870 = (0);
while(true){
if((i_17870 < arr.length)){
(arr[i_17870] = null);

var G__17871 = (i_17870 + (1));
i_17870 = G__17871;
continue;
} else {
}
...
var i_17880 = (self__.level + (1));
while(true){
if((i_17880 <= (new_level + (1)))){
(update[i_17880] = self__.header);
...
var i_17882 = (0);
while(true){
if((i_17882 <= self__.level)){
var links_17883 = (update[i_17882]).forward;
if(((links_17883[i_17882]) === x__$1)){
(links_17883[i_17882] = (x__$1.forward[i_17882]));

var G__17884 = (i_17882 + (1));
i_17882 = G__17884;
continue;
} else {
var G__17885 = (i_17882 + (1));
i_17882 = G__17885;
continue;
}
} else {
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9537__auto__,writer__9538__auto__,opt__9539__auto__){
return cljs.core._write(writer__9538__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__8866__auto__ = (cljs.core.truth_((function (){var and__8854__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__8866__auto__,timeout,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__8866__auto__,timeout,me))
,msecs);

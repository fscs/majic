...
var G__20141 = history;
var G__20142 = goog.history.EventType.NAVIGATE;
var G__20143 = ((function (G__20141,G__20142){
return (function (e){
var token = e.token;
...
;
return goog.events.listen(G__20141,G__20142,G__20143);
});
/**
...
var G__20145 = document;
var G__20146 = "click";
var G__20147 = ((function (G__20145,G__20146){
return (function (e){
var target = e.target;
var button = e.button;
...
var and__8854__auto____$1 = (function (){var fexpr__20150 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__20150.cljs$core$IFn$_invoke$arity$1 ? fexpr__20150.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__20150.call(null,link_target));
})();
if(cljs.core.truth_(and__8854__auto____$1)){
...
;
return goog.events.listen(G__20145,G__20146,G__20147);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__20151){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20152__$1,cljs.core.cst$kw$nav_DASH_handler);
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20152__$1,cljs.core.cst$kw$path_DASH_exists_QMARK_);
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20154_SHARP_){
return cljs.core.name(p1__20154_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__20155_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__20159 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__20159) : accountant.core.nav_handler.call(null,G__20159));
} else {

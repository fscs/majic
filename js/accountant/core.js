...
var G__19848 = history;
var G__19849 = goog.history.EventType.NAVIGATE;
var G__19850 = ((function (G__19848,G__19849){
return (function (e){
var token = e.token;
...
;
return goog.events.listen(G__19848,G__19849,G__19850);
});
/**
...
var G__19852 = document;
var G__19853 = "click";
var G__19854 = ((function (G__19852,G__19853){
return (function (e){
var target = e.target;
var button = e.button;
...
var and__8854__auto____$1 = (function (){var fexpr__19857 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__19857.cljs$core$IFn$_invoke$arity$1 ? fexpr__19857.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__19857.call(null,link_target));
})();
if(cljs.core.truth_(and__8854__auto____$1)){
...
;
return goog.events.listen(G__19852,G__19853,G__19854);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__19858){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19859__$1,cljs.core.cst$kw$nav_DASH_handler);
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19859__$1,cljs.core.cst$kw$path_DASH_exists_QMARK_);
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19861_SHARP_){
return cljs.core.name(p1__19861_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__19862_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__19866 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__19866) : accountant.core.nav_handler.call(null,G__19866));
} else {
